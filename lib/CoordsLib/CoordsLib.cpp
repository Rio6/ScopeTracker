 ...
 */
void CoordsLib::_inv(double m[3][3], double res[3][3]){
	double idet;
 ...
 * the third parameter.
 */
void CoordsLib::_m_prod(double m1[3][3], double m2[3][3], double res[3][3]){
	for(int i=0; i<3; i++)
		for(int j=0; j<3; j++){
			res[i][j] = 0.0;
 ...
 */
void CoordsLib::_setEVC(double ar, double dec, double t, double* EVC){
 ...
 */
void CoordsLib::_setHVC(double ac, double alt, double* HVC){
 ...
 */
void CoordsLib::setTime(double t0){
	_t0 = t0;
}
 ...
 */
void CoordsLib::setRef_1(double ar, double dec, double t, double ac, double alt){
 ...
 * If all the reference objects have been established, calls the function that calculates T and iT.
 */
void CoordsLib::setRef_2(double ar, double dec, double t, double ac, double alt){
 ...
 * If all the reference objects have been established, calls the function that calculates T and iT.
 */
void CoordsLib::setRef_3(double ar, double dec, double t, double ac, double alt){
 ...
 * proper function.
 */
void CoordsLib::getHCoords(double ar, double dec, double t, double *ac, double *alt){
	double HVC[3];
	double EVC[3];
 ...
 * proper function.
 */
void CoordsLib::getECoords(double ac, double alt, double t, double *ar, double *dec){
	double HVC[3];
	double EVC[3];
	_setHVC(ac, alt, HVC);
